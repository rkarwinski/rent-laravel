        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('insurers.index')" :active="request()->routeIs('insurers.index')">
                        {{ __('Seguros') }}
                    </x-nav-link>

                    <x-nav-link :href="route('trailer_dimensions.index')" :active="request()->routeIs('trailer_dimensions.index')">
                        {{ __('Reboques Medidas') }}
                    </x-nav-link>
