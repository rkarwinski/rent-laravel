                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('addresses.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="address" name="address" class="w-full p-2 border rounded" value="{{ old('address') }}" required>
                        </div>

                        <div class="mb-4">
                            <label for="number" class="block font-medium text-gray-700">{{ __('Número') }}</label>
                            <input type="text" id="number" name="number" class="w-full p-2 border rounded" value="{{ old('number') }}" required>
                        </div>

                        <div class="mb-4">
                            <label for="zip_code" class="block font-medium text-gray-700">{{ __('CEP') }}</label>
                            <input type="text" id="zip_code" name="zip_code" class="w-full p-2 border rounded" value="{{ old('zip_code') }}" required>
                        </div>

                        <div class="mb-4">
                            <label for="complement" class="block font-medium text-gray-700">{{ __('Complemento') }}</label>
                            <input type="text" id="complement" name="complement" class="w-full p-2 border rounded" value="{{ old('complement') }}">
                        </div>

                        <div class="mb-4">
                            <label for="neighbourhood" class="block font-medium text-gray-700">{{ __('Bairro') }}</label>
                            <input type="text" id="neighbourhood" name="neighbourhood" class="w-full p-2 border rounded" value="{{ old('neighbourhood') }}" required>
                        </div>
